	...
	public boolean onTouchEvent(MotionEvent me) {
		...
		if (me.getAction() == MotionEvent.ACTION_DOWN) {
			if (questionMark.contains(x, y)) {
				...
				Intent option = new Intent(this, Preferences.class);
...
//		float y = me.getY();
//		RectF questionMark = new RectF(0, 0.86f*h, 0.09f*w, h);
//		RectF preferences = new RectF(0, 0.1f*h, 0.09f*w, 0.19f*h);
//
//		if (me.getAction() == MotionEvent.ACTION_DOWN) {
//			if (questionMark.contains(x, y)) {
//				AlertDialog.Builder ab = new AlertDialog.Builder(this);
...
//				ab.setNeutralButton("OK", null);
//				ab.show();
//			} else if(preferences.contains(x, y)) {
//				Intent i = new Intent(this, Preferences.class);
//				startActivity(i);
//			} else {
//				Intent kari = new Intent(this, MainActivity.class);
//				startActivity(kari);
//				finish();
//			}
//		}
